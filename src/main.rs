    ...
    let matches = App::new("rgclass")
        ...
        .subcommand(SubCommand::with_name("cross_validate")
                    ...
                    .arg(Arg::with_name("max_depth")
                         ...
                         .help("Sets the optional limit to the depth of the decision tree")
                         .takes_value(true)
                         .required(false))
                    .arg(Arg::with_name("min_weight_split")
                         ...
                         .help("Sets the minimum number of samples required to split a node.")
                         .takes_value(true)
                         .required(false))
                    .arg(Arg::with_name("min_weight_leaf")
                         ...
                         .value_name("Min weight split")
                         .help("Sets the minimum he minimum number of samples that a split has to place in each leaf.")
                         .takes_value(true)
